...
class SEDTransform:
    def __init__(self, feat_params, device='cuda'):
...
class ATSTTransform:
    def __init__(self, device='cuda'):
        self.transform = MelSpectrogram(16000, f_min=60, f_max=7800, hop_length=160, win_length=1024, n_fft=1024, n_mels=64).to(device)
        self.to_db = ATSTNorm()
